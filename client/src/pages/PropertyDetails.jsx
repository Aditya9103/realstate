      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-8 xl:px-16">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-8">
          <div>
            ...
            <div className="flex items-center text-gray-500 text-sm md:text-base gap-4">
          ...
          <div className="flex items-center gap-4 lg:gap-6">
            <button className="flex flex-col items-center gap-1 text-gray-500 hover:text-[#1a2b3c] transition-colors group">
