      ...
      <form className="flex-1 flex flex-col gap-5" onSubmit={handleSubmit}>
        ...
        <div className="relative">
          ...
          <div className="absolute right-4 top-[38px] pointer-events-none">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-700"><polyline points="6 9 12 15 18 9"></polyline></svg>
          </div>
        </div>
