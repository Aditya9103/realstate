        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          <div className="flex items-start gap-5 p-4 rounded-xl bg-[#fafafa] border border-gray-100 hover:border-[#D29F54]/30 transition-colors">
            ...
            <div>
              ...
              <p className="text-sm text-gray-700 leading-relaxed">
                Mithila Legacy Realty, 6th Floor, Skyline Tower,<br/>
          ...
          <div className="flex items-start gap-5 p-4 rounded-xl bg-[#fafafa] border border-gray-100 hover:border-[#D29F54]/30 transition-colors">
            ...
            <div>
              ...
              <p className="text-sm text-gray-700 mb-0.5">+91 98765 43210</p>
              <p className="text-[11px] text-gray-600">Mon - Sat: 9:00 AM - 7:00 PM</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-5 p-4 rounded-xl bg-[#fafafa] border border-gray-100 hover:border-[#D29F54]/30 transition-colors">
            ...
            <div>
              ...
              <p className="text-sm text-gray-700 mb-0.5">hello@mithilalegacy.com</p>
              <p className="text-[11px] text-gray-600">We'll reply within 24 hours</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-5 p-4 rounded-xl bg-[#fafafa] border border-gray-100 mt-auto">
            ...
            <div className="flex-1 flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                <a href="#" className="w-8 h-8 rounded-full bg-white shadow-sm flex items-center justify-center text-gray-600 hover:text-[#D29F54] transition-colors">
      ...
      <div className="w-full xl:w-[45%] flex flex-col gap-4">
        ...
        <div className="w-full flex-1 rounded-xl overflow-hidden border border-gray-100 bg-white flex flex-col">
          ...
          <div className="p-5">
            ...
            <p className="text-[13px] text-gray-700 mb-4">We'd love to meet you in person!</p>
